...
public class Vector < E > extends AbstractList < E > implements List < E >, RandomAccess, Cloneable, Serializable {
    ...
    public Vector (int initialCapacity, int capacityIncrement) {
        super (); if (initialCapacity < 0) throw new IllegalArgumentException ("Illegal Capacity: " + initialCapacity);

        this.elementData = new Object [initialCapacity]; this.capacityIncrement = capacityIncrement;}
    ...
    public Vector (Collection < ? extends E > c) {
        elementCount = c.size (); elementData = new Object [(int) Math.min ((elementCount * 110L) / 100, Integer.MAX_VALUE)]; c
          .toArray (elementData);}
    ...
    public synchronized void trimToSize () {
        modCount ++; int oldCapacity = elementData.length;
...
"@LockObjectPatternAnnotation(patternInstanceID=1, roleID=1, roleDescription='Creation of static object in a class - lock object.')"
            */
            ...
            elementData = new Object [elementCount]; System.arraycopy (oldData, 0, elementData, 0, elementCount);}
    }

    public synchronized void ensureCapacity (int minCapacity) {
        modCount ++; ensureCapacityHelper (minCapacity);}
    ...
    private void ensureCapacityHelper (int minCapacity) {
        ...
        if (minCapacity > oldCapacity) {
            ...
            elementData = new Object [newCapacity]; System.arraycopy (oldData, 0, elementData, 0, elementCount);}
    }
    ...
    public synchronized void insertElementAt (E obj, int index) {
        ...
        ensureCapacityHelper (elementCount + 1); System.arraycopy (elementData, index, elementData, index + 1, elementCount -
          index); elementData [index] = obj; elementCount ++;}

    public synchronized void addElement (E obj) {
        modCount ++; ensureCapacityHelper (elementCount + 1); elementData [elementCount ++] = obj;}

    public synchronized boolean removeElement (Object obj) {
        modCount ++; int i = indexOf (obj);
        if (i >= 0) {
    ...
    public synchronized Object clone () {
        try {
            ...
            v.elementData = new Object [elementCount]; System.arraycopy (elementData, 0, v.elementData, 0, elementCount); v.
              modCount = 0; return v;
    ...
    public synchronized Object [] toArray () {
        ...
        System.arraycopy (elementData, 0, result, 0, elementCount); return result;
    }
    ...
    public synchronized < T > toArray (T [] a) {
        if (a.length < elementCount) a = (T []) java.lang.reflect.Array.newInstance (a.getClass ().getComponentType (),
          elementCount);
        System.arraycopy (elementData, 0, a, 0, elementCount); if (a.length > elementCount) a [elementCount] = null;
        return a;
    }
...
"@LockObjectPatternAnnotation(patternInstanceID=2, roleID=1, roleDescription='Creation of static object in a class - lock object.')"
    ...
    public synchronized boolean add (E o) {
        modCount ++; ensureCapacityHelper (elementCount + 1); elementData [elementCount ++] = o; return true;
    }
...
"@LockObjectPatternAnnotation(patternInstanceID=3, roleID=1, roleDescription='Creation of static object in a class - lock object.')"
    ...
    public synchronized boolean addAll (Collection < ? extends E > c) {
        modCount ++; Object [] a = c.toArray ();
        int numNew = a.length;
        ensureCapacityHelper (elementCount + numNew); System.arraycopy (a, 0, elementData, elementCount, numNew); elementCount
    ...
    protected synchronized void removeRange (int fromIndex, int toIndex) {
        ...
        System.arraycopy (elementData, toIndex, elementData, fromIndex, numMoved); int newElementCount = elementCount - (
          toIndex - fromIndex);
