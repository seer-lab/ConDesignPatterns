...
"@SingleThreadedExecPatternAnnotation(patternInstanceID=1, roleID=1, roleDescription='Use of synchronized keyword, Java's way of implementing a guarded method')"
    */
    public synchronized void Enter (IScheduleOrdering InSO) throws InterruptedException {
        ...
        while (MyThread != Runner) MyThread.wait ();
    ...
    public static void main (String [] args) {
        ...
        i <= 100; i ++) {
            ...
            j <= 5; j ++) {
                ...
                if (RndInt == 1) Pro.SolveProblem (P1);
                else if (RndInt == 2) Pro.SolveProblem (P2);
                else Pro.SolveProblem (P3);
...
public class Problem implements IScheduleOrdering {
    ...
    @Override public boolean ScheduleBefore (IScheduleOrdering InSO) {
        return false;
    }
