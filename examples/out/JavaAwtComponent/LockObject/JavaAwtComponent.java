...
"@LockObjectPatternAnnotation(patternInstanceID=1, roleID=1, roleDescription='Creation of static object in a class - lock object.')"
    */
    ...
    void resetGC () {
        ...
        /* "@LockObjectPatternAnnotation(patternInstanceID=2, roleID=3, roleDescription='Synchronized calls to method Role 
          2.')"*/
        synchronized (getTreeLock ()) {
            graphicsConfig = null;}
    }
    ...
    void setGCFromPeer () {
        ...
        /* "@LockObjectPatternAnnotation(patternInstanceID=3, roleID=3, roleDescription='Synchronized calls to method Role 
          2.')"*/
        synchronized (getTreeLock ()) {
            if (peer != null) {
...
"@LockObjectPatternAnnotation(patternInstanceID=1, roleID=2, roleDescription='Creation of static method in the same class as Role 1 - getLockObject().')"
    */
    ...
    public Point getMousePosition () throws HeadlessException {
        ...
        /* "@LockObjectPatternAnnotation(patternInstanceID=4, roleID=3, roleDescription='Synchronized calls to method Role 
          2.')"*/
        synchronized (getTreeLock ()) {
    ...
    public void enable () {
        if (! enabled) {
            ...
            /*
           "@LockObjectPatternAnnotation(patternInstanceID=5, roleID=3, roleDescription='Synchronized calls to method Role 
              2.')"*/
            synchronized (getTreeLock ()) {
    ...
    public void disable () {
        if (enabled) {
            ...
            /*
           "@LockObjectPatternAnnotation(patternInstanceID=6, roleID=3, roleDescription='Synchronized calls to method Role 
              2.')"*/
            synchronized (getTreeLock ()) {
    ...
    public void show () {
        if (! visible) {
            ...
            /*
           "@LockObjectPatternAnnotation(patternInstanceID=7, roleID=3, roleDescription='Synchronized calls to method Role 
              2.')"*/
            synchronized (getTreeLock ()) {
    ...
    public void hide () {
        isPacked = false; if (visible) {
            clearCurrentFocusCycleRootOnHide (); clearMostRecentFocusOwnerOnHide ();
            /*
           "@LockObjectPatternAnnotation(patternInstanceID=8, roleID=3, roleDescription='Synchronized calls to method Role 
              2.')"*/
            synchronized (getTreeLock ()) {
    ...
    public void setFont (Font f) {
        ...
        /* "@LockObjectPatternAnnotation(patternInstanceID=9, roleID=3, roleDescription='Synchronized calls to method Role 
          2.')"*/
        synchronized (getTreeLock ()) {
            synchronized (this) {
    ...
    public Point getLocationOnScreen () {
        ...
        /*
          "@LockObjectPatternAnnotation(patternInstanceID=10, roleID=3, roleDescription='Synchronized calls to method Role 
          2.')"*/
        synchronized (getTreeLock ()) {
    ...
    public void move (int x, int y) {
        ...
        /*
          "@LockObjectPatternAnnotation(patternInstanceID=11, roleID=3, roleDescription='Synchronized calls to method Role 
          2.')"*/
        synchronized (getTreeLock ()) {
    ...
    public void resize (int width, int height) {
        ...
        /*
          "@LockObjectPatternAnnotation(patternInstanceID=12, roleID=3, roleDescription='Synchronized calls to method Role 
          2.')"*/
        synchronized (getTreeLock ()) {
    ...
    public void reshape (int x, int y, int width, int height) {
        ...
        /*
          "@LockObjectPatternAnnotation(patternInstanceID=13, roleID=3, roleDescription='Synchronized calls to method Role 
          2.')"*/
        synchronized (getTreeLock ()) {
            try {
    ...
    public Dimension preferredSize () {
        ...
        if (dim == null || ! (isPreferredSizeSet () || isValid ())) {
            ...
            /*
          "@LockObjectPatternAnnotation(patternInstanceID=14, roleID=3, roleDescription='Synchronized calls to method Role 
              2.')"*/
            synchronized (getTreeLock ()) {
    ...
    public Dimension minimumSize () {
        ...
        if (dim == null || ! (isMinimumSizeSet () || isValid ())) {
            ...
            /*
          "@LockObjectPatternAnnotation(patternInstanceID=15, roleID=3, roleDescription='Synchronized calls to method Role 
              2.')"*/
            synchronized (getTreeLock ()) {
    ...
    public void validate () {
        ...
        /*
          "@LockObjectPatternAnnotation(patternInstanceID=16, roleID=3, roleDescription='Synchronized calls to method Role 
          2.')"*/
        synchronized (getTreeLock ()) {
            ComponentPeer peer = this.peer;
            if (! valid && peer != null) {
    ...
    public void invalidate () {
        ...
        /*
          "@LockObjectPatternAnnotation(patternInstanceID=17, roleID=3, roleDescription='Synchronized calls to method Role 
          2.')"*/
        synchronized (getTreeLock ()) {
    ...
    boolean dispatchMouseWheelToAncestor (MouseWheelEvent e) {
        ...
        /*
          "@LockObjectPatternAnnotation(patternInstanceID=18, roleID=3, roleDescription='Synchronized calls to method Role 
          2.')"*/
        synchronized (getTreeLock ()) {
    ...
    public void addHierarchyListener (HierarchyListener l) {
        ...
        if (notifyAncestors) {
            ...
            /*
          "@LockObjectPatternAnnotation(patternInstanceID=19, roleID=3, roleDescription='Synchronized calls to method Role 
              2.')"*/
            synchronized (getTreeLock ()) {
    ...
    public void removeHierarchyListener (HierarchyListener l) {
        ...
        if (notifyAncestors) {
            ...
            /*
          "@LockObjectPatternAnnotation(patternInstanceID=20, roleID=3, roleDescription='Synchronized calls to method Role 
              2.')"*/
            synchronized (getTreeLock ()) {
                adjustListeningChildrenOnParent (AWTEvent.HIERARCHY_EVENT_MASK, - 1);}
        }
    ...
    public void addHierarchyBoundsListener (HierarchyBoundsListener l) {
        ...
        if (notifyAncestors) {
            ...
            /*
          "@LockObjectPatternAnnotation(patternInstanceID=21, roleID=3, roleDescription='Synchronized calls to method Role 
              2.')"*/
            synchronized (getTreeLock ()) {
    ...
    public void removeHierarchyBoundsListener (HierarchyBoundsListener l) {
        ...
        if (notifyAncestors) {
            ...
            /*
          "@LockObjectPatternAnnotation(patternInstanceID=22, roleID=3, roleDescription='Synchronized calls to method Role 
              2.')"*/
            synchronized (getTreeLock ()) {
                adjustListeningChildrenOnParent (AWTEvent.HIERARCHY_BOUNDS_EVENT_MASK, - 1);}
        }
    ...
    protected final void enableEvents (long eventsToEnable) {
        ...
        if (notifyAncestors != 0) {
            ...
            /*
          "@LockObjectPatternAnnotation(patternInstanceID=23, roleID=3, roleDescription='Synchronized calls to method Role 
              2.')"*/
            synchronized (getTreeLock ()) {
    ...
    protected final void disableEvents (long eventsToDisable) {
        ...
        if (notifyAncestors != 0) {
            ...
            /*
          "@LockObjectPatternAnnotation(patternInstanceID=24, roleID=3, roleDescription='Synchronized calls to method Role 
              2.')"*/
            synchronized (getTreeLock ()) {
                adjustListeningChildrenOnParent (notifyAncestors, - 1);}
        }
    ...
    public void addNotify () {
        ...
        /*
          "@LockObjectPatternAnnotation(patternInstanceID=25, roleID=3, roleDescription='Synchronized calls to method Role 
          2.')"*/
        synchronized (getTreeLock ()) {
            ComponentPeer peer = this.peer;
            if (peer == null || peer instanceof LightweightPeer) {
    ...
    public void removeNotify () {
        ...
        /*
          "@LockObjectPatternAnnotation(patternInstanceID=26, roleID=3, roleDescription='Synchronized calls to method Role 
          2.')"*/
        synchronized (getTreeLock ()) {
...
"@LockObjectPatternAnnotation(patternInstanceID=2, roleID=1, roleDescription='Creation of static object in a class - lock object.')"
    ...
    public void add (PopupMenu popup) {
        ...
        /*
          "@LockObjectPatternAnnotation(patternInstanceID=27, roleID=3, roleDescription='Synchronized calls to method Role 
          2.')"*/
        synchronized (getTreeLock ()) {
    ...
    public void remove (MenuComponent popup) {
        ...
        /*
          "@LockObjectPatternAnnotation(patternInstanceID=28, roleID=3, roleDescription='Synchronized calls to method Role 
          2.')"*/
        synchronized (getTreeLock ()) {
            if (popups == null) {
                return;
    ...
    private void readObject (ObjectInputStream s) throws ClassNotFoundException, IOException {
        ...
        /*
"@LockObjectPatternAnnotation(patternInstanceID=3, roleID=1, roleDescription='Creation of static object in a class - lock object.')"
        */
        Object keyOrNull;
        ...
        /*
"@LockObjectPatternAnnotation(patternInstanceID=4, roleID=1, roleDescription='Creation of static object in a class - lock object.')"
        */
        Object orient = null;
        try {
    ...
    final boolean canBeFocusOwner () {
        ...
        /*
          "@LockObjectPatternAnnotation(patternInstanceID=29, roleID=3, roleDescription='Synchronized calls to method Role 
          2.')"*/
        synchronized (getTreeLock ()) {
            if (parent != null) {
    ...
    final class NativeInLightFixer implements ComponentListener, ContainerListener {
        ...
        void install (Container parent) {
            ...
            nativeHost = p; p.addContainerListener (this); componentMoved (null); if (! isLwParentsVisible) {
                ...
                /*
          "@LockObjectPatternAnnotation(patternInstanceID=30, roleID=3, roleDescription='Synchronized calls to method Role 
                  2.')"*/
                synchronized (getTreeLock ()) {
                    if (peer != null) {
                        peer.hide ();}
        ...
        public void componentMoved (ComponentEvent e) {
            ...
            /*
          "@LockObjectPatternAnnotation(patternInstanceID=31, roleID=3, roleDescription='Synchronized calls to method Role 
              2.')"*/
            synchronized (getTreeLock ()) {
                int nativeX = x;
                int nativeY = y;
        ...
        public void componentShown (ComponentEvent e) {
            if (shouldShow ()) {
                ...
                /*
          "@LockObjectPatternAnnotation(patternInstanceID=32, roleID=3, roleDescription='Synchronized calls to method Role 
                  2.')"*/
                synchronized (getTreeLock ()) {
                    if (peer != null) {
                        peer.show ();}
        ...
        public void componentHidden (ComponentEvent e) {
            if (visible) {
                ...
                /*
          "@LockObjectPatternAnnotation(patternInstanceID=33, roleID=3, roleDescription='Synchronized calls to method Role 
                  2.')"*/
                synchronized (getTreeLock ()) {
                    if (peer != null) {
                        peer.hide ();}
    ...
    protected abstract class AccessibleAWTComponent extends AccessibleContext implements Serializable, AccessibleComponent {
        ...
        public Point getLocationOnScreen () {
            ...
            /*
          "@LockObjectPatternAnnotation(patternInstanceID=34, roleID=3, roleDescription='Synchronized calls to method Role 
              2.')"*/
    ...
    int getAccessibleIndexInParent () {
        ...
        /*
          "@LockObjectPatternAnnotation(patternInstanceID=35, roleID=3, roleDescription='Synchronized calls to method Role 
          2.')"*/
        synchronized (getTreeLock ()) {
            int index = - 1;
    ...
    AccessibleStateSet getAccessibleStateSet () {
        ...
        /*
          "@LockObjectPatternAnnotation(patternInstanceID=36, roleID=3, roleDescription='Synchronized calls to method Role 
          2.')"*/
        synchronized (getTreeLock ()) {
