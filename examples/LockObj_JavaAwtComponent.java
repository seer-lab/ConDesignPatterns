         ...
         public abstract class Component implements  ImageObserver,
             ...
             void checkGD(String stringID) {
                 if (graphicsConfig != null) {
                     if (!graphicsConfig.getDevice().getIDstring().equals(
                             stringID)) {
             ...
             Component findUnderMouseInWindow(PointerInfo pi) {
                 ...
                 if (!Toolkit.getDefaultToolkit().getMouseInfoPeer()
                         .isWindowUnderMouse(win)) {
                     return null;
                 }
                 final boolean INCLUDE_DISABLED = true;
                 Point relativeToWindow = win.pointRelativeToComponent(pi
                         .getLocation());
                 Component inTheSameWindow = win.findComponentAt(
                         relativeToWindow.x, relativeToWindow.y,
                         INCLUDE_DISABLED);
                 ...
                 synchronized (getTreeLock()) {
                     try {
                         ...
                         if (peer != null) {
                             ...
                             if (!(peer instanceof  LightweightPeer)) {
                                 reshapeNativePeer(x, y, width, height,
                                         getBoundsOp());
             ...
             private void notifyNewBounds(boolean resized, boolean moved) {
                 if (componentListener != null
                     ...
                     if (this  instanceof  Container
                         ...
                         if (moved) {
                             ((Container) this ).createChildHierarchyEvents(
                                     HierarchyEvent.ANCESTOR_MOVED, 0,
                                     enabledOnToolkit);
                         }
                     }
                 }
             ...
             public Rectangle getBounds(Rectangle rv) {
                 if (rv == null) {
                     return new Rectangle(getX(), getY(), getWidth(),
                             getHeight());
                 } else {
             ...
             public Dimension preferredSize() {
                 ...
                 if (dim == null || !(isPreferredSizeSet() || isValid())) {
                     synchronized (getTreeLock()) {
                         prefSize = (peer != null) ? peer.preferredSize()
                                 : getMinimumSize();
                         dim = prefSize;
                     }
                 }
             ...
             public Graphics getGraphics() {
                 if (peer instanceof  LightweightPeer) {
                     ...
                     if (g instanceof  ConstrainableGraphics) {
                         ((ConstrainableGraphics) g).constrain(x, y, width,
                                 height);
                     } else {
                         g.translate(x, y);
             ...
             public Image createImage(int width, int height) {
                 ...
                 if (peer instanceof  LightweightPeer) {
                     ...
                     return (peer != null) ? peer.createImage(width, height)
                             : null;
                 }
             }
             ...
             public VolatileImage createVolatileImage(int width, int height) {
                 ...
                 if (peer instanceof  LightweightPeer) {
                     ...
                     return (peer != null) ? peer.createVolatileImage(width,
                             height) : null;
                 }
             }
             ...
             public boolean prepareImage(Image image, int width, int height,
                 ...
                 ComponentPeer peer = this .peer;
                 if (peer instanceof  LightweightPeer) {
                     return (parent != null) ? parent.prepareImage(image, width,
                             height, observer) : getToolkit().prepareImage(
                             image, width, height, observer);
                 } else {
                     return (peer != null) ? peer.prepareImage(image, width,
                             height, observer) : getToolkit().prepareImage(
                             image, width, height, observer);
                 }
             }
             ...
             public int checkImage(Image image, int width, int height,
                 ...
                 ComponentPeer peer = this .peer;
                 if (peer instanceof  LightweightPeer) {
                     return (parent != null) ? parent.checkImage(image, width,
                             height, observer) : getToolkit().checkImage(image,
                             width, height, observer);
                 } else {
                     return (peer != null) ? peer.checkImage(image, width,
                             height, observer) : getToolkit().checkImage(image,
                             width, height, observer);
                 }
             }
             ...
             void createBufferStrategy(int numBuffers) {
                 ...
                 if (numBuffers > 1) {
                     ...
                     bufferCaps = new BufferCapabilities(new ImageCapabilities(
                 ...
                 bufferCaps = new BufferCapabilities(
                         new ImageCapabilities(false), new ImageCapabilities(
                                 false), null);
                 try {
                     createBufferStrategy(numBuffers, bufferCaps);
                     return; // Success
             ...
             protected class BltBufferStrategy extends BufferStrategy {
                 ...
                 public Graphics getDrawGraphics() {
                     ...
                     g.constrain(-insets.left, -insets.top, backBuffer
                             .getWidth(null)
                             + insets.left, backBuffer.getHeight(null)
                             + insets.top);
                     return g;
                 }
                 ...
                 void showSubRegion(int x1, int y1, int x2, int y2) {
                     ...
                     try {
                         ...
                         for (int i = 0; i < backBuffers.length; i++) {
                             g.drawImage(backBuffers[i], x1, y1, x2, y2, x1, y1,
                                     x2, y2, null);
                             g.dispose();
                             g = null;
                         ...
                         if (inputContext != null) {
                             ...
                             if (e.isConsumed()) {
                                 if (e instanceof  FocusEvent
                                         && focusLog.isLoggable(Level.FINER)) {
             ...
             public void addHierarchyListener(HierarchyListener l) {
                 ...
                 synchronized (this ) {
                     ...
                     hierarchyListener = AWTEventMulticaster.add(
                             hierarchyListener, l);
             ...
             public void removeHierarchyListener(HierarchyListener l) {
                 ...
                 synchronized (this ) {
                     notifyAncestors = (hierarchyListener != null && (eventMask & AWTEvent.HIERARCHY_EVENT_MASK) == 0);
                     hierarchyListener = AWTEventMulticaster.remove(
                             hierarchyListener, l);
                     notifyAncestors = (notifyAncestors && hierarchyListener == null);
                 }
                 if (notifyAncestors) {
             ...
             int numListening(long mask) {
                 ...
                 if ((mask == AWTEvent.HIERARCHY_EVENT_MASK && (hierarchyListener != null || (eventMask & AWTEvent.HIERARCHY_EVENT_MASK) != 0))
                         || (mask == AWTEvent.HIERARCHY_BOUNDS_EVENT_MASK && (hierarchyBoundsListener != null || (eventMask & AWTEvent.HIERARCHY_BOUNDS_EVENT_MASK) != 0))) {
                     return 1;
                 } else {
                     return 0;
                 }
             ...
             int createHierarchyEvents(int id, Component changed,
                 ...
                 case HierarchyEvent.HIERARCHY_CHANGED:
                     if (hierarchyListener != null
                             ...
                             || enabledOnToolkit) {
                         HierarchyEvent e = new HierarchyEvent(this , id,
              ...
              * @since    1.4
              */
             public synchronized void removeMouseWheelListener(
                     MouseWheelListener l) {
                 if (l == null) {
                     return;
                 }
              ...
              * @since    1.2
              */
             public synchronized void addInputMethodListener(
                     InputMethodListener l) {
                 if (l == null) {
                     return;
                 }
                 inputMethodListener = AWTEventMulticaster.add(
                         inputMethodListener, l);
                 newEventsOnly = true;
             }
              ...
              * @since    1.2
              */
             public synchronized void removeInputMethodListener(
                     InputMethodListener l) {
                 if (l == null) {
                     return;
                 }
             ...
             public <T extends EventListener> getListeners(
             ...
             public void addNotify() {
                 synchronized (getTreeLock()) {
                     ...
                     if (peer == null || peer instanceof  LightweightPeer) {
                         ...
                         Container parent = this .parent;
                         if (parent != null
                                 && parent.peer instanceof  LightweightPeer) {
                     ...
                     if (hierarchyListener != null
                             ...
                             || Toolkit
                                     .enabledOnToolkit(AWTEvent.HIERARCHY_EVENT_MASK)) {
                         HierarchyEvent e = new HierarchyEvent(
                                 this ,
                                 HierarchyEvent.HIERARCHY_CHANGED,
                                 this ,
                                 parent,
                                 HierarchyEvent.DISPLAYABILITY_CHANGED
                                         | ((isRecursivelyVisible()) ? HierarchyEvent.SHOWING_CHANGED
                                                 : 0));
                         dispatchEvent(e);
                     }
                 }
             ...
             public void setFocusTraversalKeys(int id,
                 ...
                 if (id < 0
                         || id >= KeyboardFocusManager.TRAVERSAL_KEY_LENGTH - 1) {
                     throw new IllegalArgumentException(
             ...
             final boolean requestFocusHelper(boolean temporary,
                     boolean focusedWindowChangeAllowed,
                     CausedFocusEvent.Cause cause) {
                 if (!isRequestFocusAccepted(temporary,
             ...
             private boolean isRequestFocusAccepted(boolean temporary,
                 ...
                 Component focusOwner = KeyboardFocusManager
                         .getMostRecentFocusOwner(window);
                 if (focusOwner == null) {
             ...
             final Component preNextFocusHelper() {
                 ...
                 while (rootAncestor != null
                         && !(rootAncestor.isShowing()
                                 && rootAncestor.isFocusable() && rootAncestor
                                 .isEnabled())) {
                     comp = rootAncestor;
                     rootAncestor = comp.getFocusCycleRootAncestor();
                 }
                 if (focusLog.isLoggable(Level.FINER)) {
                     focusLog.log(Level.FINER, "comp = " + comp + ", root = "
                             + rootAncestor);
                 }
                 if (rootAncestor != null) {
                     FocusTraversalPolicy policy = rootAncestor
                             .getFocusTraversalPolicy();
                     Component toFocus = policy.getComponentAfter(rootAncestor,
                             comp);
                     if (focusLog.isLoggable(Level.FINER)) {
                         focusLog.log(Level.FINER, "component after is "
                                 + toFocus);
                     }
                     if (toFocus == null) {
                         toFocus = policy.getDefaultComponent(rootAncestor);
                         if (focusLog.isLoggable(Level.FINER)) {
                             focusLog.log(Level.FINER, "default component is "
                                     + toFocus);
                         }
                     }
                     if (toFocus == null) {
                         Applet applet = EmbeddedFrame
             ...
             static boolean postNextFocusHelper(Component toFocus,
                 ...
                 if (toFocus != null) {
                     if (focusLog.isLoggable(Level.FINER))
                         focusLog.finer("Next component " + toFocus);
                     boolean res = toFocus.requestFocusInWindow(cause);
                     if (focusLog.isLoggable(Level.FINER))
                         focusLog.finer("Request focus returned " + res);
                     return res;
                 }
                 return false;
             }
             ...
             public void transferFocusBackward() {
                 ...
                 if (rootAncestor != null) {
                     FocusTraversalPolicy policy = rootAncestor
                             .getFocusTraversalPolicy();
                     Component toFocus = policy.getComponentBefore(rootAncestor,
                             comp);
                     if (toFocus == null) {
                         toFocus = policy.getDefaultComponent(rootAncestor);
                     }
                     if (toFocus != null) {
                         toFocus
                                 .requestFocusInWindow(CausedFocusEvent.Cause.TRAVERSAL_BACKWARD);
                     }
                 }
             }
                 ...
                 if (rootAncestor != null) {
                     ...
                     KeyboardFocusManager
                             ...
                             .setGlobalCurrentFocusCycleRoot(
                                     (rootAncestorRootAncestor != null) ? rootAncestorRootAncestor
                                             : rootAncestor);
                     rootAncestor
             ...
             protected String paramString() {
                 ...
                 String str = (thisName != null ? thisName : "") + "," + x + ","
                         + y + "," + width + "x" + height;
                 if (!valid) {
                     str += ",invalid";
                 }
             ...
             private void doSwingSerialization() {
                 ...
                 for (Class klass = Component.this .getClass(); klass != null; klass = klass
                     ...
                     if (klass.getPackage() == swingPackage
                         ...
                         Method[] methods = (Method[]) AccessController
             ...
             private void writeObject(ObjectOutputStream s) throws IOException {
                 ...
                 AWTEventMulticaster.save(s, mouseMotionListenerK,
                         mouseMotionListener);
             ...
             final class NativeInLightFixer implements  ComponentListener,
                 ...
                 private boolean shouldShow() {
                     ...
                     for (int i = lightParents.size() - 1; i >= 0
                             && isLwParentsVisible; i--) {
                         isLwParentsVisible &= ((Container) lightParents
                                 .elementAt(i)).isVisible();
                     }
