...
public class Scheduler {
    ...
    @SuppressWarnings("unchecked") private ArrayList waitingRequests = new ArrayList ();
    @SuppressWarnings("unchecked") private ArrayList waitingThreads = new ArrayList ();

    @SuppressWarnings("unchecked") public void enter (ScheduleOrdering s) throws InterruptedException {
