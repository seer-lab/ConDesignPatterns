...
public class ReadWriteLock {
    ...
    @SuppressWarnings("unchecked") private ArrayList waitingForWriteLock = new ArrayList ();
...
"@SingleThreadedExecPatternAnnotation(patternInstanceID=1, roleID=1, roleDescription='Use of synchronized keyword, Java's way of implementing a guarded method')"
    */
    ...
    @SuppressWarnings("unchecked") public void writeLock () throws InterruptedException {
        Thread thisThread;
        synchronized (this) {
